...
struct ShellDatabase {
    ...
    static func populateMap() {
        ...
        shellMap["Atlantic Razor Clam"] = Shellfish(
            ...
            averageSize: 7, averageLifeSpan: 6, image: "atlantic_razor"
        )
        ...
        shellMap["Atlantic Surf Clam"] = Shellfish(
            ...
            averageSize: 6.5, averageLifeSpan: 11, image: "atlantic_surf"
        )
        ...
        shellMap["Bay Scallop"] = Shellfish(
            ...
            averageSize: 2.75, averageLifeSpan: 1.5, image: "bay_scallop"
        )
        ...
        shellMap["Blue Mussel"] = Shellfish(
            ...
            averageSize: 3, averageLifeSpan: 4, image: "blue_mussel"
        )
        ...
        shellMap["Channeled Whelk"] = Shellfish(
            ...
            averageSize: 5.5, averageLifeSpan: 12.5, image: "channeled_whelk"
        )
        ...
        shellMap["Eastern Mud Snail"] = Shellfish(
            ...
            averageSize: 0.6, averageLifeSpan: 1.5, image: "eastern_mud"
        )
        ...
        shellMap["Eastern Oyster"] = Shellfish(
            ...
            averageSize: 4.5, averageLifeSpan: 12.5, image: "eastern_oyster"
        )
        ...
        shellMap["Jingle Shell"] = Shellfish(
            ...
            averageSize: 1.4, averageLifeSpan: 2, image: "jingle_shell"
        )
        ...
        shellMap["Knobbed Whelk"] = Shellfish(
            ...
            averageSize: 6, averageLifeSpan: 12.5, image: "knobbed_whelk"
        )
        ...
        shellMap["Moon Snail"] = Shellfish(
            ...
            averageSize: 2.4, averageLifeSpan: 4, image: "moon_snail"
        )
        ...
        shellMap["Northern Quahog"] = Shellfish(
            ...
            averageSize: 3.375, averageLifeSpan: 35, image: "northern_quahog"
        )
        ...
        shellMap["Oyster Drill Snail"] = Shellfish(
            ...
            diet: "Bivalve mollusks", habitat: "Intertidal and shallow subtidal zones",
            averageSize: 0.8, averageLifeSpan: 2, image: "oyster_drill"
        )
        ...
        shellMap["Ribbed Mussel"] = Shellfish(
            ...
            averageSize: 3, averageLifeSpan: 3, image: "ribbed_mussel"
        )
        ...
        shellMap["Slipper Snail"] = Shellfish(
            ...
            averageSize: 1.2, averageLifeSpan: 1.5, image: "slipper_snail"
        )
